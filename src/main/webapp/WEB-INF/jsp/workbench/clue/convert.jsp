	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="transactionName" value="动力节点-">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
			...
			<input type="hidden" id="activityId" value="9ca18d7ef6dc4483a9edf1ecb1c4bcd6">
		    <input type="text" class="form-control" id="activity" value="市场活动1" placeholder="点击上面搜索" readonly>
		  </div>
		</form>
