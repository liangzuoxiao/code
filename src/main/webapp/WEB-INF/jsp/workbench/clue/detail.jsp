				...
				success:function (data) {
					...
					if(data.code=="0"){
						...
						$.each(data.activityList,function (i,n) {
							...
							htmlStr+="<td>"+n.endDate+"</td>";
							htmlStr+="<td>"+n.owner+"</td>";
							htmlStr+="<td><a href=\"javascript:void(0);\" activity-id=\""+n.id+"\" style=\"text-decoration: none;\"><span class=\"glyphicon glyphicon-remove\"></span>解除关联</a></td>";
							htmlStr+="</tr>";
						});
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button id="toConvertBtn" type="button" class="btn btn-default" onclick="window.location.href='convert.jsp';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
				...
				<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
					...
					<div style="position: relative; top: -40px; left: 40px;" >
						...
						<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
							<a class="myHref" name="editA" remark-id="${remark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a class="myHref" name="deleteA" remark-id="${remark.id}" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
						</div>
					</div>
				</div>
			</c:forEach>
						...
						<c:if test="${not empty activityList}">
							<c:forEach items="${activityList}" var="activity">
								<tr id="tr_${activity.id}">
									...
									<td><a href="javascript:void(0);" activity-id="${activity.id}" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>
								</tr>
							</c:forEach>
						</c:if>
						<%--<tr>--%>
