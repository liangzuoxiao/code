...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-transactionType">
				  <option></option>
				 <c:if test="${not empty tranTypeList}">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="8417b69ad1ff4cab9a8ddb0d737bce62">
				<input type="text" class="form-control" value="市场活动" id="create-activitySrc">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="8417b69ad1ff4cab9a8ddb0d737bce62">
				<input type="text" class="form-control" value="张三" id="create-contactsName">
			</div>
		</div>
